...
def main():
    run = True
    tank1 = Tank(100, 300, 0, RED_TANK_IMAGE, {'left': pygame.K_q, 'right': pygame.K_d, 'up': pygame.K_z, 'down': pygame.K_s, 'shoot': pygame.K_SPACE}, reverse_movement=True)
    tank2 = Tank(600, 300, 180, BLUE_TANK_IMAGE, {'left': pygame.K_LEFT, 'right': pygame.K_RIGHT, 'up': pygame.K_UP, 'down': pygame.K_DOWN, 'shoot': pygame.K_RETURN}, reverse_movement=True)
